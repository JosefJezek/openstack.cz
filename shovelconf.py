...
# https://github.com/dandesousa/pelican-shovel
# Modified by: [Josef Jezek](http://about.me/josefjezek)
...
#If no settings_local.py then settings.py
try:
    from settings_local import AUTHOR
except ImportError:
...
def create_new_pelican_file(file_info,directory,kwargs):
  ...
  with open(path, "w") as f:
    f.write(template.render(**tdict).encode('utf-8'))
